...
# -*- coding: utf-8 -*-
"""
Created on Sat Jul 23 1234hrs 2022
...
print(df.isnull().sum())
df_features=['MONTH','DAY','TIME','STREET1','STREET2', 'LATITUDE', 'LONGITUDE', 'ROAD_CLASS', 'DISTRICT', 'LOCCOORD', 'TRAFFCTL', 'VISIBILITY', 'LIGHT', 'RDSFCOND', 'IMPACTYPE', 'INVTYPE','INVAGE', 'INJURY', 'AUTOMOBILE', 'AG_DRIV', 'PEDESTRIAN', 'CYCLIST', 'MOTORCYCLE', 'TRUCK', 'TRSN_CITY_VEH','EMERG_VEH','PASSENGER','SPEEDING','DISABILITY', 'ALCOHOL']
